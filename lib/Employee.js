...
class Employee {
  ...
  //second argument
  static generateQuestions(employeeType, specificQuestions) {
  ...
  static _prompt(employeeType, questions) {
    return inquirer.
    prompt(Employee.generateQuestions(employeeType, questions));
  }
  ...
  constructor(name = "employee", id = "0", email = "test@email.com") {
