...
class Employee {
  ...
  //Returns inquirer.prompt object questions for any generic employee type,
  //merged together with any specific questions passed as a
  //second argument
  ...
  //First parameter takes general employee type name, eg. "Manager", "Cleaner"
  //Second parameter takes inquirer.prompt question object, questions that are
  //more relevant to any specific employee type.
